...
namespace Ecommerce_test.Areas.Admin.Controllers
{
	...
	public class OrderController : Controller
	{
        ...
        public IActionResult StartProcessing()
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Processing started Successfully";
        ...
        public IActionResult ShipOrder()
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Order shippeed Successfully";
            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
        }
        ...
        public IActionResult CancelOrder()
        {
            ...
            if(orderHeader.PaymentStatus == SD.PaymentStatusApproved){
                ...
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.Id, SD.StatusCancled, SD.StatusRefunded);
            }
            else
            {
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.Id, SD.StatusCancled, SD.StatusCancled);
            }
            _unitOfWork.Save();
